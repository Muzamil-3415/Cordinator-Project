  ...
  <div class="content">
    <div class="module">
      <div class="module-head">
        <h3>Edit Pages Inside Content</h3>
      </div>
      <div class="module-body">
        ...
        <?php
			...
			?>
        <form action="<?php echo site_url('magneto/pages_inside_content_update'); ?>" method="post" enctype="multipart/form-data" name="frm" class="form-horizontal row-fluid">
         ...
         <div class="control-group">
		  ...
		  <div class="control-group">
            ...
            <div class="controls">
              ...
              <img alt="Your uploaded image" src="<?php echo base_url(). 'upload/' . $r->image; ?>" width="100" /> <a href="<?php echo site_url('magneto/pages_inside_content_img_delete/'.$r->id); ?>" class="btn btn-primary">Delete Image</a>
              <?php }	else { ?>
              <input type="hidden" name="pic" value="<?php echo $r->image;?>" />
