  ...
  <div class="content">
    <div class="module">
      <div class="module-head">
        <h3>Edit Inside Keywords Pages</h3>
      </div>
      <div class="module-body">
        ...
        <?php
			...
			?>
        <form action="<?php echo site_url('magneto/services_inside_content_update'); ?>" method="post" enctype="multipart/form-data" name="frm" class="form-horizontal row-fluid">
          
		  <input type="hidden" name="id" value="<?php echo $r->id;?>" />
		  <input type="hidden" name="user_id" value="<?php echo $r->user_id;?>" />

        <div class="control-group">
            <label class="control-label" for="basicinput">Blog Category</label>
            <div class="controls">
