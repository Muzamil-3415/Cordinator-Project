            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 ">
                        ...
                        <?php
                        foreach ($blogresult as $blogresult) {
                        ?>
                            <div style="margin-bottom:20px; border-bottom:2px solid" class="about_txt">
                                <h3 class="blog-head1"><a href="<?php echo site_url('post/' . $blogresult->slug); ?>"><?php echo character_limiter($blogresult->blog_title, 45); //$blogresult->blog_title ; 
                                                                                                                    ?></a></h3>
                                <p>By: Rock Salt Today | Posted On: <?php echo date("F d, Y", strtotime($blogresult->created_on)); ?></p>
                                <p><?php
                                    $description = str_replace(array('\r\n', '\r', '\n'), " ", $blogresult->description);
                                    echo word_limiter(strip_tags($description), 35);
                                    ?></p>
                                <p><a href="<?php echo site_url('post/' . $blogresult->slug); ?>"> Read More <i class="fa fa-long-arrow-right"></i> </a> </p>
                        ...
                        <form id="contact-form" action="<?php echo site_url('main/contactform'); ?>" method="post" class="request-form ftco-animate fadeInUp ftco-animated">
                            ...
                            <div class="form-group">
                                ...
                                <div style="display: flex; align-items: center; gap: 10px">
                                    ...
                                    <div>
                                    <input type="text" name="captcha_input" required class="form-control" placeholder="Enter Code" style="width: 90px; height: 40px;">
                                    </div>
                                </div>
                            </div>
