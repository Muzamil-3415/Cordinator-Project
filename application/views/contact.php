...
<head>
    <title>Contact Us - Rock Salt Today</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="site-wrap">
        ...
        <div class="site-section border-bottom" data-aos="fade-down" data-aos-delay="">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center about_txt">
                        <h1>Contact Us</h1>
                        <p class="text-center">If you have any questions or comments please fill out the following form and one of our representatives will contact you as soon as possible.</p>
                        <p class="text-center"><img src="<?php echo base_url(); ?>assets/images/creditcard.jpg" class="three-img1"></p>
                    </div>
                    <div class="col-md-12">
                        <form id="contact-form" action="<?php echo site_url('main/contactform'); ?>" method="post" class="request-form ftco-animate fadeInUp ftco-animated">
                            ...
                            <!-- <div class="d-flex">
                                <div class="form-groups mr-2">
                                    <label class="label">Captcha</label>
                                    <img src="<?= base_url('main/captcha') . '?t=' . time(); ?>" alt="Captcha" id="captchaImage" style="width: 150px; height: 40px; display: block;">
                                </div>
                                <div class="form-groups ml-2">
                                    <label class="label d-none d-md-block" style="visibility: hidden;">Enter Code</label>
                                    <input type="text" name="captcha_input" placeholder="Enter Code" minlength="1" required class="form-control" style="width: 150px; height: 40px;">
                                </div>
                            </div> -->
                            <div class="form-group ml-2">
                                <label class="label">Captcha</label>
                            ...
                            <div class="form-group text-center mt-3">
                                ...
                                <input type="submit" value="REQUEST QUOTE" class="btn btn-primary py-3 px-4 text-center" style="max-width:250px; ">
                            </div>
                        </form>
