  ...
  <div class="content">
    <div class="module"> 
      <div class="module-head">
        <h3>Edit Keywords Pages [<a href="<?php echo site_url('magneto/manageservices'); ?>">Manage Record</a>]</h3>
      </div>
      <div class="module-body"> 
        ...
        <?php
			...
			?>
        <form action="<?php echo site_url('magneto/services_update'); ?>" method="post" enctype="multipart/form-data" name="frm" class="form-horizontal row-fluid">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              ...
              <img alt="Your uploaded image" src="<?php echo base_url(). 'upload/' . $r->image; ?>" width="100" /> <a href="<?php echo site_url('magneto/services_img_delete/'.$r->id.'/'."image"); ?>" class="btn btn-primary">Delete Image</a>
              <?php }	else { ?>
              <input type="hidden" name="userfile" value="<?php echo $r->image;?>" />
          ...
          <div class="control-group">
              ...
              <div class="controls">
                ...
                <a href="<?php echo site_url('magneto/services_img_delete/'.$r->id.'/'."image3"); ?>" class="btn btn-primary">Delete Image</a>
                <?php }	else { ?>
                <input type="hidden" name="userfile3" value="<?php echo $r->image3;?>" />
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <a href="<?php echo site_url('magneto/services_img_delete/'.$r->id.'/'."image4"); ?>" class="btn btn-primary">Delete Image</a>
                <?php }	else { ?>
                <input type="hidden" name="userfile4" value="<?php echo $r->image4;?>" />
          ...
          <div class="control-group">
            ...
            <div class="controls">
              ...
              if ($r->image2) { ?>
                ...
                <a href="<?php echo site_url('magneto/services_img2_delete/' . $r->id); ?>"
