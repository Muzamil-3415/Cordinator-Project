    ...
    <div class="module">
      ...
      <div class="module-body">
        ...
        <?php
			...
			?>
        <form action="<?php echo site_url('magneto/pages_insert'); ?>" method="post" enctype="multipart/form-data" name="frm" class="form-horizontal row-fluid">
