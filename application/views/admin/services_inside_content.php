        ...
        <div class="content">
          <div class="module">
			...
			<?php $pageid = $this->uri->segment(3); ?>
              <h3>Manage Inside Keywords Pages [<a href="<?php echo site_url('magneto/services_inside_content_add/'); ?>">Add Record</a>]</h3>
            </div>
				...
				$i = 1;
                  ...
                  <tr class="gradeA">
                   <td><?php echo $i++ ?></td>
                    ...
                    <td><a href="<?php echo site_url('magneto/services_inside_content_edit/'.$result->id); ?>">Edit</a></td>
					<td><a href="<?php echo site_url('magneto/services_inside_content_delete/'.$result->id); ?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                  </tr>
				  <?php				   
				  	}					
					?>
